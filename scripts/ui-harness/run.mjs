...
// formBackgroundRerender/majorReview20260921/updateCheck/home)를, 두 번째
...
const FLOWS = [autonomousTasks, sessions, catalog, settingsMcp, appLinks, formBackgroundRerender, majorReview20260921, updateCheck, home];
